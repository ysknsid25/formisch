...
Formisch is a schema-based, headless form library for SolidJS. It manages form state and validation. It is type-safe, fast by default and its bundle size is small due to its modular design. Try it out in our <Link href="/playground/login/">playground</Link>!
...
For a side-by-side look at how Formisch compares to Felte and TanStack Form, see the <Link href="/solid/guides/comparison/">comparison guide</Link>.
